...
class FourierTransformCircuits:
    ...
    def construct_circuit(
        ...
        Args:
            ...
            qubits (Union(QuantumRegister, list[Qubit])): The optional
                qubits to construct the circuit with.
            approximation_degree (int): degree of approximation for the
                desired circuit.
            inverse (bool): Boolean flag to indicate Inverse QFT.
            do_swaps (bool): Boolean flag to specify if swaps should be
                included to align the qubit order of input & output.
                The output qubits would be in reversed order without the swaps.
